...
Speech <- read_excel("C:/Users/micro computer/Desktop/rahulgandhi.xlsx",col_names = FALSE)
...
docs <- tm_map(docs, removeWords, 
               c("the", "a", "have", "is", "i","are", "will","and","that","his","with",
                 "and",  "that", "his","for","this" ,"but","who" , "not","has","had","was","were")) 
...
ggplot(data=Speech.Sentiment,aes(x=Sentiment,y=Score))+
    ...
    ggtitle("Total Avg emotions words used in speech Rahul Gandhi") 
